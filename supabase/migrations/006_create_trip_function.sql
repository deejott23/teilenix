-- Create trip + auto-join as SECURITY DEFINER to bypass RLS auth.uid() issues
...
BEGIN
  ...
  VALUES (p_name, NULLIF(p_description, ''), NULLIF(p_start_date, '')::DATE, NULLIF(p_end_date, '')::DATE, p_invite_code, auth.uid())
